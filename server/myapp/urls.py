...
urlpatterns = [
    ...
    path('admin/doctor/list', views.admin.doctor.list_api),
    path('admin/doctor/create', views.admin.doctor.create),
    path('admin/doctor/update', views.admin.doctor.update),
    path('admin/doctor/delete', views.admin.doctor.delete),
    ...
    path('index/doctor/list', views.index.doctor.list_api),
